...
//creo un array dove pusho tutti i risultati 
$active=[];
//creo un ciclo dove verifico la condizione del elemento attivo 
...
<body>
<!-- richiamo l'array con collegato tutti i vari link -->
    <a href="<?php echo $active[$random]["link"] ?>"></a>
    <img src="<?php echo $active[$random]["image_path"] ?>" alt="">
